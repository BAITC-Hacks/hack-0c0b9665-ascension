...
const indicatorsKK = { T1: 'Қозғалыс жылдамдығы', T2: 'Қоғамдық көлік', E1: 'Көгалдандыру', E2: 'Ауа сапасы', S1: 'Білім', S2: 'Денсаулық сақтау', B1: 'Қоғамдық қауіпсіздік', B2: 'Жол қауіпсіздігі', C1: 'Инфрақұрылым', C2: 'Цифрлық қызметтер' };
